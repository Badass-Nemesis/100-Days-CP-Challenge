// Question -> https://codeforces.com/problemset/problem/486/A
...
public class LiveQes2 {
    public static void main(String[] args) throws IOException {
        ...
        // don't use Math.pow in long. bahut badi duvidha mein fas jaiyega ni to
        long sumOdd = odd * odd; // sum of first n odd numbers = n^2
        long sumEven = even * (even + 1); // sum of first n even numbers = n*(n+1)
